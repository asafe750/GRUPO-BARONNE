...
export function CoverageMap() {
  ...
  return (
    <motion.section
      ref={ref}
      id="atuacao"
      aria-label="Atuação do Grupo Baronne"
      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div>
            ...
            <h2 className="mt-4 max-w-3xl font-heading text-5xl font-black uppercase leading-none text-white md:text-6xl">
          ...
          <div className="relative min-h-[22rem] overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-900 shadow-2xl md:min-h-[31rem]">
            ...
            <span className="absolute bottom-5 left-5 rounded-full border border-brand-green/45 bg-black/70 px-4 py-2 text-xs font-extrabold uppercase tracking-[0.16em] text-brand-accent backdrop-blur">
              [ FOTO REAL A ADICIONAR ]
            </span>
          </div>
        </div>

        <div className="my-20 border-t border-zinc-800" />
